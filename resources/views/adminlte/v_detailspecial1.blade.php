  ...
  <div class="content-wrapper">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th width="30px">:</th>
            <th>{{ $special1->stock }}</th>
        </tr>
        <tr>
            <th width="100px">Harga</th>
            <th width="30px">:</th>
            <th>{{ number_format($special1->harga, 0, ',', ',') }}</th>
        </tr>
        <tr>
            <th width="100px">Category</th>
            <th width="30px">:</th>
            <th>{{ $special1->category }}</th>
        </tr>
        <tr>
            <th width="100px">Photo</th>
            <th width="30px">:</th>
            <th><img src="{{ url('foto_produk/' . $special1->photo) }}" width="400px"></th>
        </tr>
        <tr>
            <th><a href="/dataspecial1" class="btn btn-success btn-sm">Back</a></th>
        </tr>
    </table>
  </div>
