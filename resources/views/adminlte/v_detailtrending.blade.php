  ...
  <div class="content-wrapper">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th width="30px">:</th>
            <th>{{ $trending->stock }}</th>
        </tr>
        <tr>
            <th width="100px">Harga</th>
            <th width="30px">:</th>
            <th>{{ number_format($trending->harga, 0, ',', ',') }}</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th width="30px">:</th>
            <th><img src="{{ url('foto_produk/' . $trending->photo) }}" width="400px"></th>
        </tr>
        <tr>
            <th><a href="/datatrending" class="btn btn-success btn-sm">Back</a></th>
        </tr>
    </table>
  </div>
</div>
