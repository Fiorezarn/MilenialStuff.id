  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Special Offer 2</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <p>Jumlah Product : {{ $totalspecial2 }}</p>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    <a href="/dataspecial2/addspecial2" class="btn btn-primary btn-sm">Add Product</a>
    <br><br>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="dataspecial2/detailspecial2/{{ $item->id }}" class="btn btn-sm btn-success">Detail</a>
                    <a href="dataspecial2/editspecial2/{{ $item->id }}" class="btn btn-sm btn-warning">Edit</a>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a href="/dataspecial2/deletespecial2/{{ $item->id }}" class="btn btn-outline-light">Iya</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
