  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Apparel</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <p>Jumlah Product : {{ $totalapparel }}</p>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    <a href="/dataapparel/addapparel" class="btn btn-primary btn-sm">Add Product</a>
    <br><br>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="dataapparel/detailapparel/{{ $item->id }}" class="btn btn-sm btn-success">Detail</a>
                    <a href="dataapparel/editapparel/{{ $item->id }}" class="btn btn-sm btn-warning">Edit</a>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a href="/dataapparel/deleteapparel/{{ $item->id }}" class="btn btn-outline-light">Iya</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
